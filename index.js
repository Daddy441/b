...
╚═════╝░╚═╝░░╚══╝╚══════╝╚═╝░░╚═╝╚═╝░░╚═╝`.red,112));
	console.log(" ");
	console.log(center(` Thanks for using this software! Edited by SneaX#9999`.white, 112));
...
client.on("ready", async() => {
	...
	setTitle("Prithvi:clone| Cloning Server");
